...
3. Add `expo-updates` plugin and `eas.json` update channels
4. Add workflow (see `.github/workflows/preview.yml` in this repo)
5. Add `EXPO_TOKEN` to GitHub Actions secrets — see [GitHub Actions secrets](#github-actions-secrets-required-for-ci)
